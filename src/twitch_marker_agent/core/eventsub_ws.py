...
# =============================================================================
# Legacy class alias for backwards compatibility (if needed)
# =============================================================================


class EventSubClient(EventSubWebSocketClient):
    """
    Legacy alias for EventSubWebSocketClient.

    Deprecated: Use EventSubWebSocketClient instead.
    """
    ...
    def __init__(
        ...
        Note: config and access_token are not used by the new implementation.
        Use EventSubWebSocketClient directly with the new API.
        """
        super().__init__(logger=logger)
        self._logger.warning(
            "EventSubClient is deprecated, use EventSubWebSocketClient instead"
        )
