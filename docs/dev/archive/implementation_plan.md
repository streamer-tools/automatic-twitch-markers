...
| ---------------- | ------------------------------------------------------- | ------ |
| Python 3.12+     | [OK] Type hints, modern syntax                             | [OK]      |
| HTTP client      | `requests` (stubbed)                                    | [OK]      |
| WebSocket        | `websockets` (stubbed)                                  | [OK]      |
| Tray             | `pystray` + `Pillow` (in requirements, not implemented) | [OK]      |
| Persistent state | `sqlite3` stdlib                                        | [OK]      |
| Logging          | `logging` stdlib                                        | [OK]      |
| Testing          | `unittest` stdlib                                       | [OK]      |
| Config           | JSON file, validated in code                            | [OK]      |
